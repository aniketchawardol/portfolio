...
const ContactSection = memo(() => {
  ...
  return (
    <div
      id="contact"
      className="w-full min-h-screen flex items-center justify-center bg-gradient-to-b from-[#1e0438] via-[#170732] to-[#0f0a29]
      py-16 relative"
    >
      <div className="container mx-auto px-4 relative z-10">
        <h2 className="text-4xl font-halfomania text-slate-200 text-center">
          Get In Touch
        </h2>
        <p className="text-center mt-2 text-slate-300 font-mono">
        ...
        <div className="flex flex-col md:flex-row gap-6 max-w-5xl mx-auto h-full">
          <div className="md:w-2/3">
            ...
            >
              <div className="relative z-10">
                <h3 className="text-2xl font-exo text-slate-200 mb-6">
                  Send a Message
                </h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label
                        htmlFor="name"
                        className="block text-sm font-medium text-slate-300 mb-1 font-mono"
                      >
                        Name
                      </label>
                      <input
                        ...
                        required
                        className="w-full px-4 py-2 bg-[#1e1b4b]/50 border border-[#4c1d95]/30 text-slate-200 focus:ring-purple-500 rounded-xl focus:outline-none focus:ring-2"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-2 bg-[#1e1b4b]/50 border border-[#4c1d95]/30 text-slate-200 focus:ring-purple-500 rounded-xl focus:outline-none focus:ring-2 resize-none"
                    />
                  </div>
                  ...
                  <div>
                    <button
                      ...
                      className={`w-full py-3 px-6 bg-[#5c4a99] ${
                        !isTouchDevice
                          ? "hover:bg-[#473677]"
                          : "active:bg-[#473677]"
          ...
          <div className="md:w-1/3 space-y-6">
                  ...
                  {socialLinksWithIcons.map((link, index) => (
                    <a
                      ...
                      className={`flex items-center gap-3 text-slate-300 ${
                        !isTouchDevice
                          ? "hover:text-purple-300 hover:bg-slate-700/30"
                          : "active:text-purple-300 active:bg-slate-700/30"
            ...
            >
              <div className="relative z-10">
                <h3 className="text-2xl font-exo text-slate-200 mb-[25px]">
                  Location
                </h3>
                ...
                <div className="mt-4 font-mono text-slate-300 border-t border-slate-700 pt-3">
